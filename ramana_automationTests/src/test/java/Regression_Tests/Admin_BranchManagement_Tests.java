...
public class Admin_BranchManagement_Tests {
	 ...
	 * 
	 * @Test(priority = 6) public void verify_student_teacher_mapping_page() throws
	 * Exception { teacherStudentMappingPage techerstudentmapping = new
	 ...
	 * }
	 * 
	 * @Test(priority = 7) public void verify_Add_remove_branches_page() throws
	 * Exception { addRemoveBranchesPage addRemoveBranches = new
	 * addRemoveBranchesPage(); addRemoveBranches.navigateToAddRemoveBranches();
	 * addRemoveBranches.verifyAddRemovBrachePage();
	 * addRemoveBranches.editBranchDetail(); addRemoveBranches.resetBranchDetails();
	 * }
	 */
