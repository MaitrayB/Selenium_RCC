...
public class ManageClass_SAT_Batch_Test_Schedule extends SAT_TemplatePage
		implements Admin_Group_SAT_Menu, Student_Batch_Schedule_Locators {
	...
	@FindBy(how = How.XPATH, using = MSG_FAIL_XPATH)
	private WebElement msg_fail;

	public WebElement getMsg_fail() {
		return msg_fail;
	}
	...
	public void scheduleTest() throws Exception {
		...
		getBtn_save().click();
		waitForMinTime();
		if (getMsg_fail().isDisplayed()) {
			Reporter.log("The test has already been taken message");
		} else {
